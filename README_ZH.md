...
<div align="center">
  ...
  <p align="center">
    钰心AI：设备 Agent 与合伙人共创生态平台。
    <br />
    基于 Quart + LangChain/LangGraph 的后端，配合 Vue 3 工作台、可视化工作流、设备工具、Skill、数字分身与 OpenAPI 交付能力。
  </p>

  <p align="center">
    <strong>本项目由 <a href="https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=yuxin-ai">Atlas Cloud</a> 赞助</strong>
  </p>
...
> 当前定位：钰心AI 正在向“设备 Agent + 合伙人共创生态”转型。以下章节描述的是当前实现底座，后续会随新架构逐步重构。

钰心AI 是结合设备级 Agent 控制、Skill 封装、数字分身与合伙人收益生态的平台。当前仓库包含 Quart 后端、Celery 后台任务、Vue 3 前端工作台、可视化工作流编排、工具治理、模型路由、Skill、记忆、计费，以及基于 OpenAPI 的对外调用能力。
...
- 后端：Python、Quart、SQLAlchemy、Celery、Socket.IO、Redis、PostgreSQL
...
- 项目地址：https://github.com/NILL-HUB/yuxin-ai
