...
Revision ID: b52800c83707
Revises: 4bd8c0f7ec6a
Create Date: 2025-06-11 15:50:03.274185
...
revision = 'b52800c83707'
down_revision = '4bd8c0f7ec6a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('api_tool', schema=None) as batch_op:
        ...
        batch_op.create_index('api_tool_provider_id_idx', ['provider_id'], unique=False)
    ...
    with op.batch_alter_table('app_dataset_join', schema=None) as batch_op:
        batch_op.create_index('app_dataset_join_app_id_idx', ['app_id'], unique=False)
        batch_op.create_index('app_dataset_join_dataset_id_idx', ['dataset_id'], unique=False)
    ...
    with op.batch_alter_table('dataset', schema=None) as batch_op:
        batch_op.create_index('dataset_account_id_idx', ['account_id'], unique=False)
        batch_op.create_index('dataset_name_idx', ['name'], unique=False)
    ...
    with op.batch_alter_table('message', schema=None) as batch_op:
        batch_op.create_index('message_app_id_idx', ['app_id'], unique=False)
    ...
    with op.batch_alter_table('message_agent_thought', schema=None) as batch_op:
        ...
        batch_op.create_index('message_agent_thought_created_by_idx', ['created_by'], unique=False)
    ...
    with op.batch_alter_table('upload_file', schema=None) as batch_op:
        batch_op.create_index('upload_file_account_id', ['account_id'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('upload_file', schema=None) as batch_op:
        batch_op.drop_index('upload_file_account_id')
    ...
    with op.batch_alter_table('message_agent_thought', schema=None) as batch_op:
        ...
        batch_op.drop_index('message_agent_thought_created_by_idx')
    ...
    with op.batch_alter_table('dataset', schema=None) as batch_op:
        batch_op.drop_index('dataset_name_idx')
        batch_op.drop_index('dataset_account_id_idx')
    ...
    with op.batch_alter_table('app_dataset_join', schema=None) as batch_op:
        ...
        batch_op.drop_index('app_dataset_join_app_id_idx')
    ...
    with op.batch_alter_table('api_tool', schema=None) as batch_op:
        batch_op.drop_index('api_tool_provider_id_idx')
