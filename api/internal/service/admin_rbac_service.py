...
class AdminRbacService:
    DEFAULT_PERMISSIONS = [
        ...
        {"code": "app:create", "name": "创建应用", "resource": "app", "action": "create", "description": "创建Agent智能体应用"},
        {"code": "app:update", "name": "更新应用", "resource": "app", "action": "update", "description": "更新应用"},
        {"code": "app:delete", "name": "删除应用", "resource": "app", "action": "delete", "description": "删除Agent智能体应用"},
        {"code": "workflow:read", "name": "查看工作流", "resource": "workflow", "action": "read", "description": "查看工作流"},
        {"code": "workflow:create", "name": "创建工作流", "resource": "workflow", "action": "create", "description": "创建工作流"},
        ...
        {"code": "tool:create", "name": "创建工具", "resource": "tool", "action": "create", "description": "创建自定义API工具"},
        {"code": "tool:update", "name": "更新工具", "resource": "tool", "action": "update", "description": "更新工具"},
        {"code": "tool:delete", "name": "删除工具", "resource": "tool", "action": "delete", "description": "删除自定义API工具"},
        {"code": "mcp:read", "name": "查看 MCP", "resource": "mcp", "action": "read", "description": "查看 MCP"},
        {"code": "mcp:create", "name": "创建 MCP", "resource": "mcp", "action": "create", "description": "创建MCP Provider"},
        {"code": "mcp:update", "name": "更新 MCP", "resource": "mcp", "action": "update", "description": "更新 MCP"},
        {"code": "mcp:delete", "name": "删除 MCP", "resource": "mcp", "action": "delete", "description": "删除MCP Provider"},
        {"code": "skill:read", "name": "查看技能", "resource": "skill", "action": "read", "description": "查看技能"},
        {"code": "skill:create", "name": "创建技能", "resource": "skill", "action": "create", "description": "创建技能包（DB 直接写入）"},
        {"code": "skill:update", "name": "更新技能", "resource": "skill", "action": "update", "description": "更新技能"},
        {"code": "skill:delete", "name": "删除技能", "resource": "skill", "action": "delete", "description": "删除 DB 来源的技能包"},
