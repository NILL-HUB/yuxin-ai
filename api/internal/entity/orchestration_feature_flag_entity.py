...
def get_default_orchestration_feature_flags() -> list[OrchestrationFeatureFlag]:
    return [
        OrchestrationFeatureFlag(
            ...
            name="Orchestrator",
            description="Enable orchestration router for assistant intent handling",
            enabled=True,
            risk_level="medium",
        ...
        OrchestrationFeatureFlag(
            ...
            description="Enable detailed task planning metadata; result synthesis execution is not wired",
            enabled=False,
            risk_level="medium",
