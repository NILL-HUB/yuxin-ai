...
class CreateAdminModelReq(Form):
    ...
    input_price_per_1k_tokens = StringField("input_price_per_1k_tokens", default="0.000000", validators=[Optional(), Length(max=32)])
    output_price_per_1k_tokens = StringField("output_price_per_1k_tokens", default="0.000000", validators=[Optional(), Length(max=32)])
...
class AdminModelResp(Schema):
    ...
    input_price_per_1k_tokens = fields.String()
    output_price_per_1k_tokens = fields.String()
    input_cost_per_1k_tokens = fields.String()
    output_cost_per_1k_tokens = fields.String()
    ...
    peak_valley_enabled = fields.String()
    cache_pricing_enabled = fields.String()
    peak_windows = fields.String()
    input_cached_price_per_1k_tokens = fields.String()
    input_cached_cost_per_1k_tokens = fields.String()
    peak_input_price_per_1k_tokens = fields.String()
    peak_output_price_per_1k_tokens = fields.String()
    peak_input_cached_price_per_1k_tokens = fields.String()
    peak_input_cost_per_1k_tokens = fields.String()
    peak_output_cost_per_1k_tokens = fields.String()
    peak_input_cached_cost_per_1k_tokens = fields.String()
    valley_input_price_per_1k_tokens = fields.String()
    valley_output_price_per_1k_tokens = fields.String()
    valley_input_cached_price_per_1k_tokens = fields.String()
    valley_input_cost_per_1k_tokens = fields.String()
    valley_output_cost_per_1k_tokens = fields.String()
    valley_input_cached_cost_per_1k_tokens = fields.String()
