...
PERMISSION_CATALOG = [
    ...
    PermissionSpec("showcase:read", "查看案例展示", "showcase", "read", "查看案例展示"),
    PermissionSpec("showcase:approve", "审核案例展示", "showcase", "approve", "审核案例展示"),
    PermissionSpec("showcase:update", "管理案例展示", "showcase", "update", "驳回或下线案例展示"),
