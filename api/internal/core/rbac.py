...
PERMISSION_CATALOG = [
    ...
    PermissionSpec("distribution:view", "查看分销管理", "distribution", "view", "查看分销管理面板"),
    PermissionSpec("distribution:manage", "管理分销关系", "distribution", "manage", "绑定/解绑分销上下级"),
    PermissionSpec("order:view", "查看订单管理", "order", "view", "查看订单面板"),
    PermissionSpec("order:manage", "管理订单", "order", "manage", "关闭待支付订单"),
    PermissionSpec("refund:view", "查看售后管理", "refund", "view", "查看退款申请"),
    PermissionSpec("refund:manage", "审核退款", "refund", "manage", "审核通过/驳回退款"),
    PermissionSpec("withdraw:view", "查看提现审核", "withdraw", "view", "查看提现申请"),
    PermissionSpec("withdraw:manage", "审核提现", "withdraw", "manage", "审核提现申请"),
    PermissionSpec("payment_config:read", "查看支付配置", "payment_config", "read", "查看支付渠道配置"),
    PermissionSpec("payment_config:manage", "管理支付配置", "payment_config", "manage", "配置支付渠道与启停"),
    PermissionSpec("system_config:read", "查看系统配置", "system_config", "read", "查看邮件/短信等系统配置"),
    PermissionSpec("system_config:manage", "管理系统配置", "system_config", "manage", "配置邮件/短信等系统通道并测试发送"),
    ...
    PermissionSpec("user:create", "创建用户", "user", "create", "管理员代建用户账号"),
    PermissionSpec("user:update", "更新用户", "user", "update", "更新用户资料、状态和会话"),
    PermissionSpec("user:disable", "禁用用户", "user", "disable", "禁用用户账号"),
    PermissionSpec("user:delete", "删除用户", "user", "delete", "删除（注销）用户账号，不可逆"),
