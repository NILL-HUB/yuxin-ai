        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              meta: { adminRequired: true, requiresAuth: true, realm: 'admin', permissions: ['recycle_bin:read'] },
            },
            {
              path: 'storage',
              name: 'admin-storage',
            ...
            },
            {
              ...
              meta: { adminRequired: true, requiresAuth: true, realm: 'admin', permissions: ['public_ai_feature:read'] },
            },
            {
            ...
            },
            {
              ...
              component: () => import('@/views/space/schedules/ListView.vue'),
              meta: { adminRequired: true, requiresAuth: true, realm: 'admin', permissions: ['schedule_task:read'] },
            },
            {
              path: 'schedules/runs/:task_id',
