...
describe('admin auth service', () => {
  ...
  it('posts admin login credentials and writes admin credential and store', async () => {
    ...
    expect(credentialStore.credential).toEqual({ access_token: 'user-token', expire_at: 1896048000 })
  ...
  it('posts admin logout and clears admin and bound user state', async () => {
